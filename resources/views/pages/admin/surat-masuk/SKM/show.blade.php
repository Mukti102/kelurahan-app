    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h3 class="fw-bold mb-3">Detail Pengajuan Surat Keterangan Miskin</h3>
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Surat Keterangan Miskin</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <!-- Detail Surat -->
                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $surat->status_perkawinan == 'kawin' ? 'Sudah Kawin' : 'Belum Kawin' }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Pekerjaan</th>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <form
                                        action="{{ route('surat-keterangan-miskin.konfirmasi', Crypt::encrypt($surat->id)) }}"
