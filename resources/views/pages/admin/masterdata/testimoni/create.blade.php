    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h3 class="fw-bold mb-3">Tambah Testimoni</h3>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form enctype="multipart/form-data" class="row" action="{{ route('testimoni.store') }}"
                                method="POST">
                                @csrf
                                <div class="col-md-10">
                                    <div class="form-group {{ $errors->has('nama') ? 'has-error' : '' }}">
                                        <label for="nama">Nama</label>
                                        <input required type="text" name="nama" value="{{ old('nama') }}"
                                    ...
                                    <div class="form-group {{ $errors->has('jabatan') ? 'has-error' : '' }}">
                                        ...
                                        <input required type="text" name="jabatan" value="{{ old('jabatan') }}"
                                    ...
                                    <div class="form-group {{ $errors->has('testimoni') ? 'has-error' : '' }}">
                                        ...
                                        <textarea cols="10" rows="5" required type="text" name="testimoni" value="{{ old('testimoni') }}"
                                            class="form-control" id="testimoni" placeholder="testimoni"></textarea>
                                        @error('testimoni')
                                            <small style="color: red" class="form-text text-muted">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="form-group {{ $errors->has('avatar') ? 'has-error' : '' }}">
                                        ...
                                        <input required type="file" name="avatar" value="{{ old('avatar') }}"
                                            class="form-control" id="avatar" placeholder="avatar" />
                                        @error('avatar')
                                            <small style="color: red" class="form-text text-muted">{{ $message }}</small>
                                        @enderror
                                    </div>
