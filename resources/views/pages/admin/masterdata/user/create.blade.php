            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form enctype="multipart/form-data" class="row" action="{{ route('user.store') }}"
                                method="POST">
                                @csrf
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{ $errors->has('nomor_ktp') ? 'has-error' : '' }}">
                                        ...
                                        <input required type="text" name="nomor_ktp" class="form-control" id="nomor_ktp"
                                            placeholder="nomor_ktp Pemohon" />
                                        @error('nomor_ktp')
                                            <small style="color: red" class="form-text text-muted">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{ $errors->has('Alamat') ? 'has-error' : '' }}">
                                        ...
                                        <textarea name="alamat" class="form-control" id="comment" rows="5">
                                        </textarea>
                                        @error('alamat')
                                            <small style="color: red" class="form-text text-muted">{{ $message }}</small>
                                        @enderror
