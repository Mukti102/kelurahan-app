...
@section('title', 'Pengajuan Surat Surat Pengantar SKCK')
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Surat Pengantar SKCK
                            </h4>
                        </div>
                        <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            <a href="{{ route('surat-skck.pdf', $item->id) }}"
                                                            ...
                                                            <form
                                                                action="{{ route('surat-pengantar-skck.destroy', $item->id) }}"
