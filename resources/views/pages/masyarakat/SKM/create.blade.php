...
@section('title', 'Pengajuan Surat Keterangan Miskin')

@section('content')
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h3 class="fw-bold mb-3">Pengajuan Surat Keterangan Miskin </h3>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="row" enctype="multipart/form-data" action="{{ route('surat-keterangan-miskin.store') }}" method="POST">
                                @csrf
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('nama_pemohon') ? 'has-error' : '' }}">
                                        <label for="nama_pemohon">Nama Pemohon</label>
                                        <input value="{{ old('nama_pemohon') }}" required type="text" name="nama_pemohon"
                                            class="form-control" id="nama_pemohon" placeholder="Nama Pemohon">
                                        @error('nama_pemohon')
                                    ...
                                    <div class="form-group {{ $errors->has('nik_pemohon') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ old('nik_pemohon') }}" required type="text" class="form-control"
                                            id="nik_pemohon" name="nik_pemohon" placeholder="NIK Pemohon">
                                        @error('nik_pemohon')
                                            <small style="color: red" class="form-text text-muted">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('keperluan') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ old('keperluan') }}" required type="text"
                                    ...
                                    <div class="form-group {{ $errors->has('penghasilan') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ old('penghasilan') }}" required type="text"
                                    ...
                                    <div
                                        ...
                                        <input value="{{ old('jeumlah_anggota_keluarga') }}" required type="number"
                                    ...
                                    <div class="form-group {{ $errors->has('scan_surat_keterangan') ? 'has-error' : '' }}">
                                        <label for="scan_surat_keterangan">Scan Keterangan ( Opsional )</label>
                                        <input value="{{ old('scan_surat_keterangan') }}" type="file" class="form-control"
                                            id="scan_surat_keterangan" name="scan_surat_keterangan" placeholder="" />
