    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h3 class="fw-bold mb-3">Data Pengajuan Surat Keterangan Miskin</h3>
                <ul class="breadcrumbs mb-3">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('surat-keterangan-miskin.index') }}">SKMD</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Surat Keterangan Miskin
                            </h4>
                        </div>
                        <div class="card-body">
                                                    ...
                                                    <td>
                                                        <div class="btn-group gap-1">
                                                            @if ($item->letter->status == 'sedang diproses' || $item->letter->status == null)
                                                                <a href="{{ route('surat-keterangan-miskin.edit', Crypt::encrypt($item->id)) }}"
