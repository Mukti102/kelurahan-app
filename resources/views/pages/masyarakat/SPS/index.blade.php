...
@section('title', 'Pengajuan Surat Pengantar SKCK ')

@section('content')
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h3 class="fw-bold mb-3">Data Pengajuan Surat Pengantar SKCK</h3>
                <ul class="breadcrumbs mb-3">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('surat-pengantar-skck.index') }}">SPN</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Data Surat Keterangan Penganta SKCK
                            </h4>
                        </div>
                        <div class="card-body">
                                                    ...
                                                    <td>
                                                        <div class="btn-group gap-1">
                                                            @if ($item->letter->status == 'sedang diproses' || $item->letter->status == null)
                                                                <a href="{{ route('surat-pengantar-skck.edit', Crypt::encrypt($item->id)) }}"
