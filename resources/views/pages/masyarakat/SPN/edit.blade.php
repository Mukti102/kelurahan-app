    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h3 class="fw-bold mb-3">Update Pengajuan Surat Pengantar Nikah</h3>
                            ...
                            enctype="multipart/form-data"
                                ...
                                <div class="col-md-2 col-lg-6">
                                    ...
                                    <div class="form-group {{ $errors->has('nama_lengkap') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->nama_lengkap }}" required type="text"
                                    ...
                                    <div class="form-group {{ $errors->has('nik') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->nik }}" required type="text" name="nik"
                                    ...
                                    <div class="form-group {{ $errors->has('status_perkawinan') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->status_perkawinan }}" required type="text"
                                    ...
                                    <div class="form-group {{ $errors->has('alamat') ? 'has-error' : '' }}">
                                        ...
                                        <textarea required class="form-control" id="alamat" name="alamat" placeholder="Alamat">{{ $surat->alamat }}</textarea>
                                        @error('alamat')
                                            <small style="color: red"
                                                class="form-text text-muted">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="col-md-2 col-lg-6">
                                    ...
                                    <div class="form-group {{ $errors->has('nama_lengkap_ayah') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->nama_lengkap_ayah }}" required type="text"
                                    ...
                                    <div class="form-group {{ $errors->has('nik_ayah') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->nik_ayah }}" required type="text"
                                    ...
                                    <div class="form-group {{ $errors->has('tempat_lahir_ayah') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->tempat_lahir_ayah }}" required type="text"
                                    ...
                                    <div class="form-group {{ $errors->has('tanggal_lahir_ayah') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->tanggal_lahir_ayah }}" required type="date"
                                    ...
                                    <div class="form-group {{ $errors->has('kewarganegaraan_ayah') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->kewarganegaraan_ayah }}" required type="text"
                                    ...
                                    <div class="form-group {{ $errors->has('agama_ayah') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->agama_ayah }}" required type="text"
                                    ...
                                    <div class="form-group {{ $errors->has('pekerjaan_ayah') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->pekerjaan_ayah }}" required type="text"
                                    ...
                                    <div class="form-group {{ $errors->has('alamat_ayah') ? 'has-error' : '' }}">
                                        ...
                                        <textarea required class="form-control" id="alamat_ayah" name="alamat_ayah" placeholder="Alamat Ayah">{{ $surat->alamat_ayah }}</textarea>
                                        @error('alamat_ayah')
                                            <small style="color: red"
                                                class="form-text text-muted">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="form-group {{ $errors->has('nama_lengkap_ibu') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->nama_lengkap_ibu }}" required type="text"
                                    ...
                                    <div class="form-group {{ $errors->has('nik_ibu') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->nik_ibu }}" required type="text"
                                            class="form-control" id="nik_ibu" name="nik_ibu" placeholder="NIK Ibu" />
                                        @error('nik_ibu')
                                            <small style="color: red"
                                                class="form-text text-muted">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="form-group {{ $errors->has('tempat_lahir_ibu') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->tempat_lahir_ibu }}" required type="text"
                                    ...
                                    <div class="form-group {{ $errors->has('tanggal_lahir_ibu') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->tanggal_lahir_ibu }}" required type="date"
                                    ...
                                    <div class="form-group {{ $errors->has('kewarganegaraan_ibu') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->kewarganegaraan_ibu }}" required type="text"
                                    ...
                                    <div class="form-group {{ $errors->has('pekerjaan_ibu') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->pekerjaan_ibu }}" required type="text"
