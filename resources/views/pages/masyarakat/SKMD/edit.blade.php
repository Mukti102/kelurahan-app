    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h3 class="fw-bold mb-3">Update Pengajuan Surat Keterangan Meninggal Dunia </h3>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="row"
                                ...
                                action="{{ route('surat-keterangan-meninggal-dunia.update', Crypt::encrypt($surat->id)) }}"
                                method="POST">
                                @method('PUT')
                                @csrf
                                <div class="col-md-2 col-lg-6">
                                    <div class="form-group {{ $errors->has('nama_almarhum') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->nama_almarhum }}" required type="text"
                                ...
                                <div class="col-md-2 col-lg-6">
                                    ...
                                    <div class="form-group {{ $errors->has('tanggal_meninggal') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->tanggal_meninggal }}" required type="date"
                                    ...
                                    <div class="form-group {{ $errors->has('tempat_kematian') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->tempat_kematian }}" required type="text"
                                    ...
                                    <div class="form-group {{ $errors->has('penyebab_meninggal') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->penyebab_meninggal }}" required type="text"
                                    ...
                                    <div class="form-group {{ $errors->has('tempat_pemakaman') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->tempat_pemakaman }}" required type="text"
                                    ...
                                    <div class="form-group {{ $errors->has('tanggal_pembumikan') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ $surat->tanggal_pembumikan }}" required type="date"
                                    ...
                                    <div
                                        class="form-group {{ $errors->has('scan_surat_keterangan_rm') ? 'has-error' : '' }}">
                                        <label for="scan_surat_keterangan_rm">Scan Surat Keterangan Rumah Sakit (Jika
                                            Ada)</label>
                                        <input value="{{ old('scan_surat_keterangan_rm') }}" type="file"
                                            class="form-control" id="scan_surat_keterangan_rm"
                                            name="scan_surat_keterangan_rm" placeholder="Di Kebumikan Pada Tanggal" />
                                    ...
                                    <div class="form-group {{ $errors->has('scan_ktp_pelapor') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ old('scan_ktp_pelapor') }}"  type="file"
