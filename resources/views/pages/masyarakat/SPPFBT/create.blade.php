    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h3 class="fw-bold mb-3">Pengajuan Surat Penguasaan Tanah</h3>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form enctype="multipart/form-data" class="row" action="{{ route('surat-pernyataan-penguasaan-tanah.store') }}"
                                method="POST">
                                @csrf
                                <div class="col-md-2 col-lg-6">
                                    ...
                                    <div class="form-group {{ $errors->has('luas_tanah') ? 'has-error' : '' }}">
                                        ...
                                        <input required type="number" name="luas_tanah" class="form-control"
                                            id="luas_tanah" placeholder="Luas Tanah" />
                                        @error('luas_tanah')
                                            <small style="color: red" class="form-text text-muted">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-2 col-lg-6">
                                    ...
                                    {{-- berkas --}}
                                    <div
                                        class="form-group {{ $errors->has('scan_ktp') ? 'has-error' : '' }}">
                                        <label for="scan_ktp">Scan KTP Pemohon</label>
                                        <input value="{{ old('scan_ktp') }}" required type="file"
                                            class="form-control" id="scan_ktp"
                                            name="scan_ktp" placeholder="" />
                                        @error('scan_ktp')
                                            <small style="color: red"
                                                class="form-text text-muted">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div
                                        class="form-group {{ $errors->has('scan_kk') ? 'has-error' : '' }}">
                                        <label for="scan_kk">Scan Kartu Keluarga (KK)</label>
                                        <input value="{{ old('scan_kk') }}" required type="file"
                                            class="form-control" id="scan_kk"
                                            name="scan_kk" placeholder="" />
                                        @error('scan_kk')
                                            <small style="color: red"
                                                class="form-text text-muted">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="form-group {{ $errors->has('scan_SPPT_PBB') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ old('scan_SPPT_PBB') }}" type="file"
                                            class="form-control" id="scan_SPPT_PBB" name="scan_SPPT_PBB"
                                            placeholder="" />
                                        @error('scan_SPPT_PBB')
                                            <small style="color: red"
                                                class="form-text text-muted">{{ $message }}</small>
                                    ...
                                    <div class="form-group {{ $errors->has('scan_surat_bukti') ? 'has-error' : '' }}">
                                        ...
                                        <input value="{{ old('scan_surat_bukti') }}" type="file"
                                            class="form-control" id="scan_surat_bukti" name="scan_surat_bukti"
                                            placeholder="" />
