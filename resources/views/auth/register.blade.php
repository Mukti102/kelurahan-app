<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- nomor ktp -->
        <div class="mt-4">
            <x-input-label for="nomor_ktp" :value="__('Nomor Kartu Tanda Penduduk')" />
            <x-text-input id="nomor_ktp" class="block mt-1 w-full" type="text" name="nomor_ktp" :value="old('nomor_ktp')"
                required autocomplete="username" />
